			...
			<div class="flex pt-24 pb-24 md:pb-12">
				...
				<div class="w-1/2">
					<ul class="text-lg md:text-2xl flex flex-col gap-y-3 md:gap-y-1">
						...
						<li><a href="https://www.instagram.com/direct/t/17843933291461387" target="_blank"><span class="hover:text-[#64E69E] block leading-none md:leading-normal">Envíanos un DM a Instagram</span></a></li>
					</ul>
				</div>
			</div>
