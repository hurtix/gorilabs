...
<aside>
    <div class="fixed flex md:block z-1 bg-white bottom-0 left-0 md:top-0 md:right-0 md:left-auto w-full md:w-[10%] md:h-screen border-t md:border-t-0 md:border-l border-gray-200">
        <div class="md:h-[50%] w-1/2 md:w-auto">
            <a class="font-display uppercase h-full flex justify-center items-center hover:bg-[#64E69E] hover:text-white py-4 md:py-0 text-center" href="https://api.whatsapp.com/send?phone=573012956665&text=Hola%20*GORILABS*%2C%20estoy%20interesado%20en%20recibir%20m%C3%A1s%20informaci%C3%B3n" target="_blank">
